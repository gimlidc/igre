...
def cnn_baseline_experiment(config_file):
    ...
    for file in samples:
        ...
        train_X, train_y = phantom['train'][..., pad, pad, :16], phantom['train'][..., pad, pad, predicted_channel]
        valid_X, valid_y = phantom['valid'][..., pad, pad, :16], phantom['valid'][..., pad, pad, predicted_channel]
